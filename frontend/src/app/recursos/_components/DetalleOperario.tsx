...
import { User, Phone, Activity, Calendar, FileText, Clock, CheckCircle2, AlertCircle, ChevronDown, ChevronUp } from "lucide-react";
...
export default function DetalleOperario({ operario, tasks: initialTasks = [], onClose, onCambiarEstado }: DetalleOperarioProps) {
      ...
      <DialogContent className="max-w-[95vw] w-full h-[90vh] flex flex-col p-0 gap-0 overflow-hidden sm:max-w-[95vw]">
        <DialogHeader className="px-6 py-4 border-b bg-gray-50/50 flex-shrink-0">
          <div className="flex items-start justify-between">
            <div>
              <DialogTitle className="text-xl">Perfil del Operario</DialogTitle>
              <DialogDescription>Detalle de actividad y asignaciones</DialogDescription>
            </div>
