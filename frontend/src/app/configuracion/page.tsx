      ...
      case 'recursos':
        return (
          <div className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Gestión de Recursos</h3>
            <p className="text-gray-500">Administra los recursos disponibles en el sistema</p>
          </div>
        );
      case 'usuarios':
        return (
      ...
      case 'materiales':
        return (
          <div className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Gestión de Materiales</h3>
            <p className="text-gray-500">Configura los materiales y sus propiedades</p>
          </div>
        );
      case 'notificaciones':
        return (
          <div className="p-8 text-center">
            <div className="text-gray-400 mb-4">
              <svg className="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M15 17h5l-5 5v-5M4 3h16a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1z" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Configuración de Notificaciones</h3>
            <p className="text-gray-500">Establece las preferencias de notificaciones</p>
          </div>
        );
      case 'sistema':
        return (
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Administre los parámetros y ajustes del SPPM</p>
      </div>
